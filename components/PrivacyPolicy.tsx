  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">2. Finalidad del tratamiento</h2>
        ...
        {/* 3. Base legal */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">3. Base legal</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">4. Conservación de datos</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-white mb-2">Algeciras Construcciones</h3>
            <p className="text-gray-300">Email: fercho.ba@gmail.com</p>
            <p className="text-gray-300">Teléfono: +57 301 293 1285</p>
          </div>
        </div>
