      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gray-800 rounded-lg p-8 md:p-12">
          <div className="prose prose-invert max-w-none">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">4. Uso del formulario de contacto</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            {/* 6. Uso prohibido */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">6. Uso prohibido</h2>
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-700 rounded-lg p-4">
                <p className="text-white font-semibold">AGL Construcciones SAS</p>
                <p className="text-gray-300">Email: fercho.ba@gmail.com</p>
                <p className="text-gray-300">Teléfono: +57 301 291 1219</p>
              </div>
            </div>
