    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Nuestra Historia y Compromiso</h1>
          <p className="text-xl text-gray-400">Conoce más sobre AGL CONSTRUCCIONES SAS</p>
        </div>
      </section>
